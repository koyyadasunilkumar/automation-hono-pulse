...
public class HonohrPulseCreateSurveyDefineEngagementParameterTest extends BaseHonoPulseAutomationTest {
	
	private WebDriver driver = null;

	private HonohrPulseCreateSurveyDefineEngagementParameterPage honoEngagementParameterPage = null;

	private static final Logger logger = Logger.getLogger(HonohrPulseCreateSurveyDefineEngagementParameterTest.class.getName());
	...
	public void verifyConfiguration() {
		...
		try {
			...
			Assert.assertEquals(honoEngagementParameterPage.getEngagementParameterText(),
					expectedAssertionsProp.getProperty(ENGAGEMENT_PARAMETER_TEXT));
	...
	public void verifyAddNewEngagementParameterWithEmptyFields() {
		...
		try {
			...
			Assert.assertEquals(honoEngagementParameterPage.getAddEngagaeMentParameterText(),
					expectedAssertionsProp.getProperty(ADD_NEW_ENGAGEMENT_PAGEMETER));
			...
			Assert.assertEquals(honoEngagementParameterPage.getEngagementParameterText(),
					expectedAssertionsProp.getProperty(PARAMETER_NAME_IS_REQUIRED));
			
			Assert.assertEquals(honoEngagementParameterPage.getScaleStartValueRequiredText(),
					expectedAssertionsProp.getProperty(SCALE_START_VALUE_IS_REQUIRED));
			
			Assert.assertEquals(honoEngagementParameterPage.getEndValueIsRequiredText(),
					expectedAssertionsProp.getProperty(SCALE_END_VALUE_IS_REQUIRED));
	...
	public void verifyAddNewEngagementParameterWithOnlyEngagementParameterName() {
		...
		try {
			...
			Assert.assertEquals(honoEngagementParameterPage.getStartValueIsRequiredText(),
					expectedAssertionsProp.getProperty(SCALE_START_VALUE_IS_REQUIRED));
	...
	public void verifyAddNewEngagementParameterWithoutEngagementParameterName() {
		...
		try {
			...
			//Assert.assertEquals(honoEngagementParameterPage.ParameterNameIsRequired(),
				//expectedAssertionsProp.getProperty(PARAMETER_NAME_IS_REQUIRED));
			
			assertTrue(this.honoEngagementParameterPage.isParameterNameIsRequiredMessageDisplayed());
	...
	public void verifyAddNewSubParameter() {
		...
		try {
			...
			Assert.assertEquals(honoEngagementParameterPage.getAddSubParameterEmployeeOnBoardText(),
					expectedAssertionsProp.getProperty(ADD_NEW_SUB_PARAMETER));
	...
	public void verifyAddNewSubParameterByLeavingEngagementparameter() {
		...
		try {
			  ...
			  Assert.assertEquals(honoEngagementParameterPage.getAddSubParameterEmployeeOnBoardText(),
			  expectedAssertionsProp.getProperty(ADD_NEW_SUB_PARAMETER_EMPLOYEE_ON_BOARD));
			 
					
			honoEngagementParameterPage.clickOnSubParameterSaveButton();
			
			Assert.assertEquals(honoEngagementParameterPage.getParameterNameIsRequiredText(),
					expectedAssertionsProp.getProperty(PARAMETER_NAME_IS_REQUIRED));
	...
	public void verifyUpdateEngagementParameterNameWithEmptyValue() {
		...
		try {
			...
			Assert.assertEquals(honoEngagementParameterPage.getUpadteEngagementParameterText(),
		    		   expectedAssertionsProp.getProperty(UPDATE_ENGAGEMENT_PARAMETER));
	...
	public void verifyUpdateEngagementParameterWithEmptyScaleStartValue() {
		...
		try {
			...
			Assert.assertEquals(honoEngagementParameterPage.getEmployeeEngagementParameterUpdatedSuccessfullyText(),
		    		   expectedAssertionsProp.getProperty(EMPLOYEE_ENGAGEMENT_PARAMETER_UPDATED_SUCCESSFULLY));
