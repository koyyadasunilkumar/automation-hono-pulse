package com.honohr.pulse.base.pages;
	...
	public class BaseHonoPulseAutomationPage {

		protected WebDriver driver = null;

		private static final Logger logger = Logger.getLogger(BaseHonoPulseAutomationPage.class.getName());

		public static String TEST_FILE_PATH = null;

		public BaseHonoPulseAutomationPage(WebDriver driver) {
			this.driver = driver;
